...
CREATE TABLE `role_info` (
  ...
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='角色基本信息';
...
CREATE TABLE `user_info` (
  ...
  `depart_id` int(11) NOT NULL COMMENT '所在部门',
  `gender` int(11) NOT NULL COMMENT '性别',
  `role_id` int(11) NOT NULL COMMENT '用户角色',
  `user_state` int(11) NOT NULL COMMENT '用户状态',
  `if_delete_user` int(11) NOT NULL COMMENT '1:未删除 0:已删除',
...
CREATE TABLE `user_state` (
  `user_state_id` int(11) NOT NULL DEFAULT '0' COMMENT '1:正常状态 0:被屏蔽',
